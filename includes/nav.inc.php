...
<head>
  ...
  <!-- FAVICON LINK -->
  <link rel="icon" href="./assets/images/logo_light.png" type="image/x-icon" />

  <!-- TITLE OF THE PAGE -->
  <title>Joylink | The breaking news | <?php echo $page_title; ?></title>

  <!-- FONTAWESOME LINK -->
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.13.0/css/all.min.css" />
  
  <!--<meta name="google-adsense-account" content="ca-pub-5198186440983541">-->
 <script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-3192549599592633"
...
<body>
  ...
  <!-- ======== NAVBAR ======== -->
  <nav class="navbar">
    <div class="logo"><a href="./index.php"><img height="50px" src="./assets/images/logo_light.png" /></a></div>
